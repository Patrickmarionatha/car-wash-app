...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="/">A'e Car Wash</a>
        <button class="navbar-toggler alert-danger" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
        ...
        <div class="collapse navbar-collapse text-right" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-warning" href="/service">Service</a>
                </li>
                <li class="nav-item">
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link text-warning" href="/login"><i class="bi bi-box-arrow-in-right"></i> Login</a>
                    </li>
                @endauth
            </ul>
        </div>
